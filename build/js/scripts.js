...
app.controller('appCtrl', function($scope, AuthService, $location, AUTH_EVENTS, $window) {
...
app.controller('loginCtrl', function($scope, $http, API_ENDPOINT, AuthService, $location, $window) {
    $scope.isAuthenticated = function() {
        return AuthService.isAuthenticated();
    }
    if (AuthService.isAuthenticated())  {
